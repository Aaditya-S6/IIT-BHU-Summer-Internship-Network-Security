    ...
    with open(output_file, 'a', newline='') as csvfile:
        ...
        for flow_key, flow_packets in flows.items():
            ...
            if recv_payload_length > 0: 
                ...
                payload_ratio = float('inf')  # Set to infinity if no payload received
                
            writer.writerow(["YouTube", payload_ratio])
    
    print(f"Flow information stored in {output_file}.")

# Usage example
pcap_folder = pcap_folder = pcap_folder = "D:\IIT BHU Intership\Dataset\Mobile_Applications_Traffic (1)\Mobile_Applications_Traffic\youtube-20230531T093352Z-001\youtube"
output_file = "D:\IIT BHU Intership\CSV Files\csv15.csv"
